...
#     '''
#     warnings.warn("Please use scikit-image's skimage.io.imread", DeprecationWarning)
#     image = imread(fn)
...
#     '''
#     warnings.warn("Please yeastcells.yit.get_ground_truth", DeprecationWarning)
...
#             =============  ==================================================
#     '''
#     warnings.warn("Not needed, yeastcells.tracking.track_cells", DeprecationWarning)
...
def get_pred_yeaz(labels, labels_grouped, coordinates):
    ...
    warnings.warn("Probably replaced, probably deprecated, need to double check", DeprecationWarning)
    pred_s= np.zeros(((len(labels),4))).astype(int)
    i=0
